...
# export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk1.8.0_51.jdk/Contens/Home
...
export HDFS_NAMENODE_OPTS="-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8888"
export HDFS_DATANODE_OPTS="-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8889"
